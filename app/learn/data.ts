...
export const courseData: Section[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        title: '二、了解 Google',
        type: 'docx',
        url: '/content/foundation-2/foundation-2.md',
    renderAs: 'markdown',
      },
      {
        id: 'foundation-3',
        ...
        type: 'docx',
        url: '/content/foundation-3/foundation-3.md',
    renderAs: 'markdown',
      },
      {
        id: 'foundation-4',
        ...
        type: 'docx',
        url: '/content/foundation-4/foundation-4.md',
    renderAs: 'markdown',
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            title: '搜索广告的原理',
            type: 'docx',
            url: '/content/search-1/search-1.md',
    renderAs: 'markdown',
          },
          {
            id: 'search-2',
            title: '搜索广告的组成',
            type: 'docx',
            url: '/content/search-2/search-2.md',
    renderAs: 'markdown',
          },
          {
            id: 'search-hw1',
    ...
    renderAs: 'markdown',
          ...
          },
          {
            ...
            title: '搜索广告的出价策略',
            type: 'docx',
            url: '/content/search-3/search-3.md',
    renderAs: 'markdown',
          },
          {
            id: 'search-hw2',
    ...
    renderAs: 'markdown',
          ...
          },
          {
            ...
            title: '搜索广告的创建',
            type: 'docx',
            url: '/content/search-4/search-4.md',
    renderAs: 'markdown',
          },
          {
            id: 'search-hw3',
    ...
    renderAs: 'markdown',
          ...
          },
          {
            ...
            title: '搜索广告数据分析与优化',
            type: 'docx',
            url: '/content/search-5/search-5.md',
    renderAs: 'markdown',
          },
          {
            id: 'search-hw4',
        ...
        children: [
          {
            ...
            title: '购物广告的原理及展示组成',
            type: 'docx',
            url: '/content/shopping-1/shopping-1.md',
    renderAs: 'markdown',
          },
          {
            id: 'shopping-2',
            title: '购物广告的重要基站-GMC',
            type: 'docx',
            url: '/content/shopping-2/shopping-2.md',
    renderAs: 'markdown',
          },
          {
            id: 'shopping-3',
            ...
            type: 'docx',
            url: '/content/shopping-3/shopping-3.md',
    renderAs: 'markdown',
          },
          {
            id: 'shopping-hw1',
    ...
    renderAs: 'markdown',
          ...
          },
          {
            ...
            title: '购物广告的数据分析与优化',
            type: 'docx',
            url: '/content/shopping-4/shopping-4.md',
    renderAs: 'markdown',
          },
          {
            id: 'shopping-hw2',
        ...
        children: [
          {
            ...
            type: 'docx',
            url: '/content/demand-1/demand-1.md',
    renderAs: 'markdown',
          },
          {
            id: 'demand-2',
            ...
            type: 'docx',
            url: '/content/demand-2/demand-2.md',
    renderAs: 'markdown',
          },
          {
            id: 'demand-3',
            ...
            type: 'docx',
            url: '/content/demand-3/demand-3.md',
    renderAs: 'markdown',
          },
          {
            id: 'demand-hw1',
        ...
        children: [
          {
            ...
            title: '视频广告的原理',
            type: 'docx',
            url: '/content/video-1/video-1.md',
    renderAs: 'markdown',
          },
          {
            id: 'video-2',
            title: '创建视频广告',
            type: 'docx',
            url: '/content/video-2/video-2.md',
    renderAs: 'markdown',
          },
          {
            id: 'video-3',
            title: '视频广告的数据指标',
            type: 'docx',
            url: '/content/video-3/video-3.md',
    renderAs: 'markdown',
          },
        ],
      },
